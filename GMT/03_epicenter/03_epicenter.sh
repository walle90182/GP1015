...
gmt psbasemap -R119/123/21/26 -Jm4 -B1 -G0/250/250 -P -O -K >> $out_ps
gmt pscoast -R -J -B -W1 -G250/250/0 -Df -Ia -P -O -K >> $out_ps
...
echo "121.87 24.84 M:4.6 Depth:5.9km" | gmt pstext -R -J -O -K -F+f,Helvetica-Bold,black >> $out_ps
